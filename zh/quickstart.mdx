...
<CardGroup cols={2}>
  <Card title="認證" icon="key" href="/zh/authentication">
    了解 API 認證詳情
  </Card>
  <Card title="Webhook 簽名" icon="shield-check" href="/zh/webhooks/signatures">
    實現安全的 Webhook 簽名驗證
  </Card>
  <Card title="測試" icon="flask" href="/zh/testing">
    使用沙盒環境進行開發測試
  </Card>
  <Card title="程式碼範例" icon="code" href="/zh/guides/code-examples">
