...
Kyren Pay uses API keys to authenticate requests. You can manage your API keys from the [Merchant Dashboard](https://merchant.kyrenpay.com).
...
| --- | --- | --- |
| Production | `https://api.kyrenpay.com` | `kyren_live_` |
