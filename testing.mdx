...
| --- | --- |
| Production API | `https://api.kyrenpay.com` |
...
<Steps>
  <Step title="Replace API keys">
    Use the production key issued for `api.kyrenpay.com`
  </Step>
  <Step title="Update base URL">
    If Kyren issued a staging base URL, change from that URL to `api.kyrenpay.com`
  </Step>
